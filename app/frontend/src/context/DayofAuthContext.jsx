...
import api from '../api/dayofClient';

const DayofAuthContext = createContext(null);

export function DayofAuthProvider({ children }) {
  ...
  return <DayofAuthContext.Provider value={value}>{children}</DayofAuthContext.Provider>;
}

export function useDayofAuth() { return useContext(DayofAuthContext); }
